...
export const COURSES: Course[] = [
  ...
  },
  {
    ...
    levels: [
      ...
      { id:'c1-l7', courseId:1, index:8, title:'The Transformer',        description:'Assemble a GPT-style decoder from scratch.',                  xp:500, type:'boss',      lessonFile:'c1/08_transformer.md',      challengeFile:'c1/07_transformer.py',     estimateMinutes:60 },
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    levels: [
      ...
      { id:'c3-l6', courseId:3, index:7, title:'Architecture Defense',    description:'Justify an architecture choice against three alternatives.',    xp:500, type:'boss',      lessonFile:'c3/12_decision_defense.md', challengeFile:'c3/06_state_budget.py',       estimateMinutes:60 },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    levels: [
      ...
      { id:'c6-l5', courseId:6, index:2, title:'Inter-Rater Agreement',  description:'Compute Cohen\'s κ and diagnose rubric failures.',            xp:150, type:'challenge', lessonFile:'c6/02_rubrics_and_agreement.md', challengeFile:'c6/05_agreement.py',     estimateMinutes:25 },
      ...
      { id:'c6-l2', courseId:6, index:5, title:'Distil a Student',       description:'Train a compact model to mimic a teacher on relevance.',     xp:200, type:'challenge', lessonFile:'c6/07_distillation.md',       challengeFile:'c6/02_distill_student.py', estimateMinutes:40 },
  ...
  },
  {
    ...
    levels: [
      ...
      { id:'c7-l4', courseId:7, index:4, title:'Circuit Breaker',        description:'Open a circuit when the failure count crosses a threshold.',  xp:200, type:'challenge', lessonFile:'c7/06b_circuit_breaker.md',      challengeFile:'c7/04_circuit_breaker.py', estimateMinutes:35 },
