...
export const MODEL_LESSONS: InteractiveLesson[] = [
  ...
  },
  {
    ...
    steps:[
      ...
      {kind:'predict',prompt:'Predict whether five repeated completions will vary.',questions:[{label:'With temperature-1 sampling, what is the expected result?',options:['They may differ because choices are sampled','They must be identical','Only IDs differ'],answer:0,reveal:'Random sampling can introduce variation at every position.'},{label:'With temperature 0 instead, what is the expected result?',options:['All five would be identical','They would still differ','Sampling becomes impossible'],answer:0,reveal:'Temperature 0 collapses to greedy argmax, removing all variation.'}]},
    ],
  },
  {
